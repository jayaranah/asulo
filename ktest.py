...
import time, random, sys, json, codecs, threading, glob, re, string, os, requests, subprocess, six, ast, pytz, urllib, urllib.parse, wikipedia, atexit, datetime, pafy, youtube_dl
...
botStart = time.time()
#==============================================================================================================
client = LINE ("EwW2pLxuoG3VxTZ83Pcb.VHH0q0Dhr8pSns5/+RsmgW.pqWWNGLI/y1L97S1Q2eVFZ5swNTEwwEmYP+l8cAuGfk=")
#==============================================================================================================
